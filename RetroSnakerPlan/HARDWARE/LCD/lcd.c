...
//函数原型：void fWriteHz24(u8 *hzP,u16 v16PosX,u16 v16PosY,u8 v8Zoom,u16 v16Color)
//函数功能：坐标 v16PosX,v16PosY作为左上角起点，用v16Color颜色，写出汉字，放大v8Zoom
//入口参数：……
//出口参数：
//函数调用：
//其他说明：

void fWriteHz24(char *hzP,u16 v16PosX,u16 v16PosY,u8 v8Zoom,u16 v16Color)
{
	u8 v8Col,v8Row,v8I,v8J,v8Index;
	u8 v8HzData;
	u16 v16X,v16Y;
	...
	for (v8Row = 0 ; v8Row < 24; v8Row ++) //24行
	{
		for(v8Col = 0 ; v8Col < 3 ; v8Col ++)//每行 3个字节
		{
			v8HzData = *hzP++;
			for(v8Index = 0 ; v8Index < 8 ; v8Index ++)//写其中一个字节对应的8点
			{
				if(v8HzData & 0x80) POINT_COLOR = v16Color ;
				else
				{
						POINT_COLOR = WHITE;
				}
				for( v8J = 0 ; v8J < v8Zoom; v8J ++)
				{
					for( v8I = 0 ; v8I < v8Zoom; v8I++)
					{
						LCD_DrawPoint(v16X,v16Y );
						v16X ++;
					}
					v16X = v16X - v8Zoom;
					v16Y ++;
